...
if ( ! class_exists( 'JD_Event_Listing' ) ) :
	...
	final class JD_Event_Listing {
		...
		public function register_events_cpt() {
			$labels = array(
				'name'               => _x( 'Events', 'event type general name', 'jd-event-listing' ),
				'singular_name'      => _x( 'Event', 'event type singular name', 'jd-event-listing' ),
				'menu_name'          => _x( 'Events', 'admin menu', 'jd-event-listing' ),
				'name_admin_bar'     => _x( 'Event', 'add new on admin bar', 'jd-event-listing' ),
				'add_new'            => _x( 'Add New', 'event', 'jd-event-listing' ),
				'add_new_item'       => __( 'Add New Event', 'jd-event-listing' ),
				'new_item'           => __( 'New Event', 'jd-event-listing' ),
				'edit_item'          => __( 'Edit Event', 'jd-event-listing' ),
				'view_item'          => __( 'View Event', 'jd-event-listing' ),
				'all_items'          => __( 'All Events', 'jd-event-listing' ),
				'search_items'       => __( 'Search Events', 'jd-event-listing' ),
				'parent_item_colon'  => __( 'Parent Events:', 'jd-event-listing' ),
				'not_found'          => __( 'No events found.', 'jd-event-listing' ),
				'not_found_in_trash' => __( 'No events found in Trash.', 'jd-event-listing' ),
			);

			$args = array(
				'labels'             => $labels,
				'description'        => __( 'Event Listing', 'jd-event-listing' ),
				'public'             => true,
